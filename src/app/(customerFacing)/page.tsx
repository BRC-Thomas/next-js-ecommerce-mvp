...
export default function Home() {
  return (
    <main className="space-y-12">
      <ProductGridSection title="Most Popular" productsFetcher={getMostPopularProduct}></ProductGridSection>
      <ProductGridSection title="Newest" productsFetcher={getNewestProduct}></ProductGridSection>
